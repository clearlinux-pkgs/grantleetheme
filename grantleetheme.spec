...
Version  : 24.12.3
Release  : 84
URL      : https://download.kde.org/stable/release-service/24.12.3/src/grantleetheme-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/grantleetheme-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/grantleetheme-24.12.3.tar.xz.sig
...
%setup -q -n grantleetheme-24.12.3
cd %{_builddir}/grantleetheme-24.12.3
pushd ..
cp -a grantleetheme-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742461105
mkdir -p clr-build
pushd clr-build
