...
%prep
%setup -q -n grantleetheme-20.04.0
cd %{_builddir}/grantleetheme-20.04.0
...
cp %{_builddir}/grantleetheme-20.04.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/grantleetheme/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
