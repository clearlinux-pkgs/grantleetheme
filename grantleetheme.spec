...
Version  : 20.12.1
Release  : 30
URL      : https://download.kde.org/stable/release-service/20.12.1/src/grantleetheme-20.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/grantleetheme-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/grantleetheme-20.12.1.tar.xz.sig
...
%prep
%setup -q -n grantleetheme-20.12.1
cd %{_builddir}/grantleetheme-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610041410
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/grantleetheme-20.12.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/grantleetheme/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/grantleetheme-20.12.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/grantleetheme/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/grantleetheme-20.12.1/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/grantleetheme/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5GrantleeTheme.so.5.16.1
